...
class Neuron {
  ...
  void calculateOutput() {
    if (this.inputConnections.isNotEmpty && this.inputFunction != null && this.activationFunction!=null) {
  ...
  bool get isThreshold{
    if(this.inputConnections.isEmpty && this.activationFunction == null && this.inputFunction == null && this.input == 1 && this.output == 1 && this.outputConnections.length == 1){
      return true;
    }else{
      return false;
    }
